...
#define TIMACQ           (TIM2)
//#define TIMACQ_CNTR_ADD  (TIM2_BaseAddress + &(((TIM2_TypeDef*)0) -> CNTRH))
...
#define LOADREF_BIT        (1<<5)               /**< LOADREF pin mask */
...
#define SCKEY_P1_A  (1<<7)  /**< Single channel key Port 1: 1st key mask */
#define SCKEY_P1_B  (1<<6)     /**< Single channel key Port 1: 2nd key mask */
#define SCKEY_P1_C  (1<<4)     /**< Single channel key Port 1: 3rd key mask */
#define SCKEY_P1_D  (1<<3)     /**< Single channel key Port 1: 4th key mask */
...
#define GPIOC_ELECTRODES_MASK  (0xD8)  /**< Electrodes mask for GPIOC */
